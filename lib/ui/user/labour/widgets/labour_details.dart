...
class LabourDetails extends StatefulWidget {
  ...
  const LabourDetails({super.key, required this.members, required this.showInOutButton});
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
            ...
            child: widget.showInOutButton ? Padding(
              ...
              child: ListTile(
                ...
                leading: CircleAvatar(
                  ...
                  radius: 16,
                  child: Text(
                    widget.members[index].laborName.isNotEmpty ? widget.members[index].laborName[0].toUpperCase() : '?',
